...
class sendmail:
    def __init__(self, email_from, pwd, email_to, file, tile='自动化测试报告', text='详情见附件，请查收！', type='163',
...
if __name__ == '__main__':
    ...
    print(mes)
    file = 'F:\\ZHAF\\HtmlTestReport\\2020-09-01-13-58-澎思云智慧安防p1.html'

    S = sendmail(mes['from'], mes['pwd'], mes['to'], file, type='qq')
    S.send()
